...
-- Adding a "Copy all" hotkey
vim.keymap.set({ "n", "v" }, "<C-a>", ":%y+<CR>", { noremap = true, silent = true, desc = "Copy all to clipboard" })

-- Adding a "remove windows line endings" hotkey
vim.keymap.set("n", ",,", ":%s/\r//g", { noremap = true, silent = true, desc = "Remove windows line endings" })
